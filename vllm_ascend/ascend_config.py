...
class AscendConfig:
    ...
    def __init__(self, vllm_config: "VllmConfig"):
        ...
        self.enable_matmul_all_gather = self._get_config_value(
            additional_config,
            "enable_matmul_all_gather",
            "VLLM_ASCEND_ENABLE_MATMUL_ALL_GATHER",
            ascend_envs.VLLM_ASCEND_ENABLE_MATMUL_ALL_GATHER,
        )
